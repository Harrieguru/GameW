...
export default {
    ...
    mounted() {
        document.title = 'Checkout | GameWizz'

        this.cart = this.$store.state.cart

        if(this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51MmRWGHxaAxjwD1lIIzvcoKWmJEf8lqiFYDrOJFbkk6mVIQdfAQCPzt7oeorcdZ0BNsoODEANDNrhG6LAcg502MF002cwbW9oQ')
    ...
    methods: {
        ...
        submitForm() {
            ...
            if(this.last_name === '') {
                this.errors.push('The last name is empty!')
            }
